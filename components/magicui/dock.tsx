...
const dockVariants = cva(
  "mx-auto mt-8 p-2 flex rounded-2xl border border-slate-200 supports-backdrop-blur:bg-white/10 supports-backdrop-blur:dark:bg-black/10 mx-auto mt-8 items-center justify-center rounded-2xl border border-slate-200 p-2 backdrop-blur-md dark:border-slate-800 gap-1 md:gap-2",
);
